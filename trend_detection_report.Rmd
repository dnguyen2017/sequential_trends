...
As a comparison to figure 1. c-d in White (2019) I ran simulations to assess how the performance of the sequential test performs relative to the fixed sample test for the same trend and sd values used by WHite. For these values, the average sample size needed of the sequential test needed to detect a trend is rougly equal to as little as half the samples needed under the fixed sample test.
