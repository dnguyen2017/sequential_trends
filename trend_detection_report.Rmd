...
Linear regression is commonly used to detect trends in population data. Consider a stochastic population model,
...
I don't like the behavior of this model when there is no trend. The distribution isn't stationary so I don't think this is a fair test. This is a gaussian random walk which is distributed at the n^th^ time point as $\overset{n}{\Sigma} Z_i \sim  N(0,n\sigma)$ where $Z_i \overset{iid}{\sim} N(0,\sigma)$. That is, the variance is unbounded as $n \rightarrow \inf$.
