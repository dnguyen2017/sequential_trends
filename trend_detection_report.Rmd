...
$\hat{\sigma}$ is computed as a [running variance](https://www.johndcook.com/blog/standard_deviation/) from the first differences of the observations $X_t - X_{t-1} \overset{iid}{\sim} N(r,\sigma)$ for $t = 2,3,4,\ldots$.
...
```{r}
test <- sim_log_gomp(log(1000), 2.4, 0.65, phi = 0, sd_proc = 0.4, sd_obs = 0, tfinal = 100, nsim = 100)
